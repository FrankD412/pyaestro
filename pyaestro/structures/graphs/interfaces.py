...
from pyaestro.abstracts.graphs import GraphEdgeInterface
from pyaestro.typing import Comparable


class BidirectionalGraphInterface(GraphEdgeInterface):
...
class DirectedGraphInterface(GraphEdgeInterface):
    def add_edge(
